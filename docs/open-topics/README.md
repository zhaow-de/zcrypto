...
- [T0017 — Regime-overlay tuning](T0017-regime-overlay-tuning.md) — **[Medium]** iter-23 found the regime gate had been inert since iter-12 (a qlib `get_risk_degree` bug); once fixed, the slow binary-200d gate Pareto-beats `steady` OOS (mean Sharpe 0.289 vs 0.154) while faster gates whipsaw — refine via anti-whipsaw/graded/vol-target and combine with a market-neutral book.
