...
- [T0026 — Genuine out-of-time holdout (the reserved-holdout governance gap)](T0026-genuine-out-of-time-holdout.md) — the "reserved holdout" was never walled off (the test segment overlaps the oos_2025 stress window already in momentum's +0.200), so no in-sample candidate can be independently confirmed; freeze a genuine out-of-time holdout + forward validation, the partner gap to T0025.
