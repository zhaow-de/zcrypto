"""momentum_tilt_hicost recipe — iter-49 cost-sensitivity: momentum_tilt at 2x maker-fill haircut.

Exact copy of momentum_tilt with maker_fill_haircut doubled (0.00021654... → 0.00043309...,
~2.2 bps → ~4.3 bps) to stress-test whether momentum_tilt's edge survives higher turnover costs.
A/B pair: momentum_tilt_hicost vs beta_null_hicost (both at 2x haircut, isolating the momentum
contribution net of elevated cost).
"""
