"""beta_null_confirm5 recipe — beta_null + 5-day anti-whipsaw confirmation filter.

iter-53 A/B: tests whether a 5-day confirmation debounce on the BTC-200d binary gate
cuts harmful whipsaw around the 200d crossing and improves the passive-beta yardstick.
Verdict pending stress A/B vs beta_null.
"""
