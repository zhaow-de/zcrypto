"""beta_null_vt55 recipe — beta_null with vol_target=0.55.

iter-55 vol_target fine-sweep: tests whether a slightly higher vol_target (0.55) refines the
beta_null yardstick. One of four sweep variants (vt40/vt45/vt55/vt60) bracketing the 0.50
baseline. Everything else is identical to beta_null.
"""
