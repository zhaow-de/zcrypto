"""momentum_tilt_k15 recipe — iter-50 k-strength dose-response sweep of momentum_tilt.

Identical to momentum_tilt (iter-47) except momentum_tilt_k=1.5 (1.5x tilt strength).
