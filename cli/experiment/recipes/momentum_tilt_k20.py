"""momentum_tilt_k20 recipe — iter-50 k-strength dose-response sweep of momentum_tilt.

Identical to momentum_tilt (iter-47) except momentum_tilt_k=2.0 (double tilt strength).
Tests the dose-response of the tilt-strength knob in the momentum-tilt strategy.
"""
