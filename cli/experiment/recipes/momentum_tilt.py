"""momentum_tilt recipe — beta_null + cross-sectional price momentum tilt.

iter-47 Stage-2: A/B vs beta_null isolating pure cross-sectional momentum (overweight recent
relative winners within the held basket). Adds momentum_tilt=True, momentum_lookback=30,
momentum_tilt_k=1.0 to beta_null's frozen book; everything else unchanged so the delta
isolates the momentum weighting. Verdict pending stress A/B.
"""
