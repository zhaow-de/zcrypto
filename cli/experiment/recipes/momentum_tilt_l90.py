"""momentum_tilt_l90 recipe — iter-48 lookback-robustness sweep of momentum_tilt.

Identical to momentum_tilt (iter-47) except momentum_lookback=90 (90-day window).
