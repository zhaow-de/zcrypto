"""smart_money_tilt recipe — beta_null + smart-money L/S divergence tilt.

iter-43 Stage-2: A/B vs beta_null isolating the top-trader vs retail L/S ratio signal.
Adds smart_money=True, smart_money_tilt_k=1.0 to beta_null's frozen book; everything
else unchanged so the delta isolates the smart-money weighting.  Verdict pending stress A/B.
"""
