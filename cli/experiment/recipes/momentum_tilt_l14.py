"""momentum_tilt_l14 recipe — iter-48 lookback-robustness sweep of momentum_tilt.

Identical to momentum_tilt (iter-47) except momentum_lookback=14 (14-day window).
Tests whether the momentum-tilt edge is robust to the lookback knob.
"""
