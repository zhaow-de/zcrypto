"""momentum_tilt_k05 recipe — iter-50 k-strength dose-response sweep of momentum_tilt.

Identical to momentum_tilt (iter-47) except momentum_tilt_k=0.5 (half tilt strength).
